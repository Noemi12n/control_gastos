 ...
 <table border CELLPADDING=5 CELLSPACING=1 >
 	...
 	<th height="25" width="70" TD BGCOLOR="pink">Fecha</th>
    <th height="25" width="70" TD BGCOLOR="pink">Usuario</th>
    <th height="25" width="70" TD BGCOLOR="pink">Concepto</th>
 	<th height="25" width="75" TD BGCOLOR="pink">Tipo</th>
 	<th height="25" width="70" TD BGCOLOR="pink">Cantidad</th>
 	<th height="25" width="70" TD BGCOLOR="pink">Detalle</th>
     <?php
     $t_ing=0;
     $t_egr=0;
     $t_saldo=0;
